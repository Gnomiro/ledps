import catalogue, duration, enemy, element, modifier, numpy
...
class Simulator:
  ...
  def __init__(self, collection_, mainAttack_, enemy_ = None, rotationType_='priority'):
    ...
    self._durationContainer = duration.DurationContainer(self._collection)
    ...
    def simulate(self, endtime_=1000):
        ...
        while t <= endtime_:
            ...
            allModifier = self._persistentModifier + modifier.fromBuff(self._durationContainer)
