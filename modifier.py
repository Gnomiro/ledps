...
class Modifier():
  ...
  def getIncrease(self, *args_, **kwargs_):
    ...
    sum = 0
    for i, j, k in product(['generic', types['attackType_']] if types['attackType_'] != 'generic' else ['generic'], ['generic', types['damageType_']] if types['damageType_'] != 'generic' else ['generic'], ['generic', types['elementType_']] if types['elementType_'] != 'generic' else ['generic']):
